...
def prepare_dataset():
    print("[START] AuraLens 데이터셋 자동 분류를 시작합니다...")
    ...
    for cls in classes:
        ...
        if total_imgs == 0:
            print(f"  [ERROR] '{cls}' 카테고리 이미지가 0장입니다. 압축 해제 폴더명을 확인하세요.")
            continue
    ...
    print("\n[DONE] 모든 데이터셋 세팅이 완벽하게 끝났습니다! AI 학습 준비 완료!")
